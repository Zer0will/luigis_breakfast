          ...
          <div className="lg:col-span-5">
            <div className="polaroid tilt-r rounded-md">
              ...
              <div className="pt-3 px-1">
                <div className="font-hand text-2xl text-brick leading-tight">
                  From our kitchen
                </div>
                <div className="text-[12px] text-charcoal/65 mt-0.5">
                  A Saturday morning, last week.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <p className="mt-5 text-[17px] text-charcoal/85 leading-relaxed">
              ...
              learning the regulars, still tuning the menu, still figuring out
              the exact moment to flip the pancake. If something isn't right,
              please tell us — at the table or on a postcard left under your
              mug.
            </p>
            <p className="mt-4 text-[17px] text-charcoal/85 leading-relaxed">
              We'll make it right the same morning. And the next time you come
              in, we'll remember.
            </p>
            <blockquote className="mt-6 border-l-4 border-brick pl-5 italic font-display text-[20px] text-charcoal max-w-xl">
              "The breakfast burrito SLAPS. The omelette was massive. We'll be
              back."
              <footer className="mt-2 not-italic font-body text-[13px] text-charcoal/65">
                — A Redmond regular, on Yelp
              </footer>
            </blockquote>
          </div>
        </div>
          ...
          <div className="relative grid md:grid-cols-2 gap-6 p-8 sm:p-14">
            <div>
              ...
              <p className="mt-4 text-ink/80 text-[16px] leading-relaxed max-w-md">
                Walk in any morning between 8 and 3. Bring the family. Bring
                your laptop. Bring a friend who needs a good breakfast.
              </p>
            ...
            <div className="flex md:justify-end">
              <div className="bg-cream rounded-2xl p-6 sm:p-7 shadow-lg max-w-sm w-full">
                <div className="font-display text-[15px] uppercase tracking-[0.16em] text-brick font-semibold">
                  Visit
                </div>
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-2 text-brick font-semibold"
                >
